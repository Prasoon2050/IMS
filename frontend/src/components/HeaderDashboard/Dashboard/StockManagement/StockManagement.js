...
const StockManagement = ({ role }) => {
  ...
  const handleConfirmDelete = () => {
    axios
      .delete(
        `https://shopsense-api.vercel.app/api/admin/stock/${itemToDelete}`,
        {
          headers: {
  ...
  const handleConfirmSave = () => {
    ...
    axios
      .put(
        `https://shopsense-api.vercel.app/api/admin/stock/${editProductName}`,
        updatedStock,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const fetchStockData = () => {
    axios
      .get("https://shopsense-api.vercel.app/api/admin/stock", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
